...
public class ConnectionSQL implements Connection {
    public String addElement(String Table, String column, Object value) throws SQLException {
        String sql = "INSERT INTO \"" + Table + "\"(" + column + ")" + "VALUES (" + value + ")";
        Statement smt = this.createStatement();
        ResultSet rs = smt.executeQuery(sql);
        return "successfully added";
    }
    public String eraseElement(String Table, String column, String id) throws SQLException {
